...
puts "[WhereAmI - Info - User Location] Google Accepted Request!"
          loc_data["results"][0]["address_components"].each do |component|
            ...
            elsif component["types"].include? "postal_town"
      ...
      utterance = SiriAssistantUtteranceView.new("You are here:","I have located you on #{map.location.street}. Here's a map.")
  ...
  filter "SetRequestOrigin", direction: :from_iphone do |object|
    ...
    if request_pending == true
      if object["properties"]["status"] == "Denied"
        ...
        say "I can't find you. Please turn on location services."
      else
  ...
  listen_for /(where am i|what's my location|what is my location)/i do
    ...
    add_views.make_root(last_ref_id)
    getloc_view = SiriAssistantUtteranceView.new("I am looking for you, please wait a moment.\u2026")
